...
Phy/UnderwaterPhy set Pt_  160   
#0.2818
Phy/UnderwaterPhy set freq_  25  ;# 25khz  
Phy/UnderwaterPhy set K_ 2.0    ;# spherical spreading


#added by yishan su for test
#begin

Phy/UnderwaterPhy set shallowwatermodel_ 1; #use new model or not
Phy/UnderwaterPhy set waterdepth_ 100    ;
Phy/UnderwaterPhy set soundspeeddiff_ 0 ;
Phy/UnderwaterPhy set sedimenttype_ 1    ;

Phy/UnderwaterPhy set noisemodel_ 0;
Phy/UnderwaterPhy set shipping_ 0;
Phy/UnderwaterPhy set wind_ 0;
